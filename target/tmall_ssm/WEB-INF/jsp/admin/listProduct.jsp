    ...
    <div class="listDataTableDiv">
        <table
            ...
            <tr class="success">
                ...
                <th width="53px" style="text-align: center">原价格</th>
                ...
                <th width="42px" style="text-align: center">编辑</th>
                <th width="42px" style="text-align: center">删除</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${ps}" var="p">
                <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle">${p.subTitle}</td>
                    <td style="text-align: center; vertical-align: middle">${p.originalPrice}</td>
                    <td style="text-align: center; vertical-align: middle">${p.promotePrice}</td>
                    <td style="text-align: center; vertical-align: middle">${p.stock}</td>
                    <td style="text-align: center; vertical-align: middle"><a
                            href="admin_productImage_list?pid=${p.id}"><span
                            class="glyphicon glyphicon-picture"></span></a></td>
                    <td style="text-align: center; vertical-align: middle"><a
                            href="admin_propertyValue_edit?pid=${p.id}"><span
                            class="glyphicon glyphicon-th-list"></span></a></td>

                    <td style="text-align: center; vertical-align: middle"><a href="admin_product_edit?id=${p.id}"><span
